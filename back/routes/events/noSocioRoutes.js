...
router.get('/participantes/:id',[checkToken, tokenCanAdmin], controlador.getNoSocioConIdEvento);
router.get('/', controlador.noSociosGet);
router.get('/:id', controlador.noSocioGet);
router.post('/:idEvento',[checkToken, tokenCanAdmin], controlador.noSocioInsert);
